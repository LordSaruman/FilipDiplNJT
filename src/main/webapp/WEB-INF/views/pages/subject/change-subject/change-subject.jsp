        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Predmeti
                            <small>sve informacije o predmetu nad kojim se vrši izmena</small>
                        </h2>
                            ...
                            <form class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="subject-name" name="subject-name" required="required"
                                               class="form-control col-md-7 col-xs-12" value="${subject.nameOfTheSubject}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select name="type-of-study" id="type-of-study" style="width: 100%" data-value="${subject.typeOfStudies}">
                                ...
                                <div class="form-group">
                                    <label for="year-of-study"
                                           class="control-label col-md-3 col-sm-3 col-xs-12">Godina Studija<span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="year-of-study" class="form-control col-md-7 col-xs-12"
                                               type="text" name="year-of-study" value="${subject.year}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="course" name="course" required="required"
                                               class="form-control col-md-7 col-xs-12" value="${subject.course}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="espb" name="espb" required="required"
                                               class="form-control col-md-7 col-xs-12" value="${subject.espb}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="students-number" name="students-number" required="required"
                                               class="form-control col-md-7 col-xs-12" value="${subject.numberOfStudents}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="lecturer-number" name="lecturer-number" required="required"
                                               class="form-control col-md-7 col-xs-12" value="${subject.numberOfLectures}">
                                    </div>
                                </div>
                            </form>
