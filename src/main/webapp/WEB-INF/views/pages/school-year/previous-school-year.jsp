    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Trenutna Školska Godina <small>pregled najbitnijih informacija</small></h3>
            </div>
        </div>
                        ...
                        <section class="content invoice">
                            ...
                            <div class="row">
                                <div class="col-xs-12 invoice-header">
                                    <h1>
                                        <i class="fa fa-globe"></i> Faktura.
                                        <small class="pull-right">Datum: 16/08/2016</small>
                                    </h1>
                                </div>
                                <!-- /.col -->
                            </div>
