    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Stara obaveštenja<small>Zaposlenov mail i poruke</small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="#">Označi kao proćitane</a></li>
                                </ul>
                            </li>
                            <li><a class="close-link-disable"><i class="fa fa-close"></i></a>
                            </li>
                        </ul>
                        <div class="clearfix"></div>
                    </div>
                            ...
                            <div class="col-sm-9 mail_view">
                                <div class="inbox-body">
                                    <div class="mail_heading row">
                                        ...
                                        <div class="col-md-4 text-right"><p class="date"> 8:02 PM 12 FEB 2014</p></div>
                                        <div class="col-md-12">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="#" class="atch-thumb">
                                                    <img src="<c:url value='/resources/img/inbox.png' />" alt="img"/>
                                                </a>
