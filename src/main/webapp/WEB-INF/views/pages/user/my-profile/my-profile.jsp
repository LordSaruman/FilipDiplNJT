                    ...
                    <div class="x_content">
                        <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    <img class="img-responsive avatar-view" src="<c:url value='/resources/img/my-profile-user-image.jpg' />" alt="Avatar"
                            ...
                            <!-- start skills -->
                            <h4>Pregled angažovanja</h4>
                            <ul class="list-unstyled user_data">
                                <li>
                                    <p>Broj studenta na predmetu</p>
                                ...
                                <li>
                                    <p>Broj prijavljenih završnih radova</p>
                                    <div class="progress progress_sm">
                                        <div class="progress-bar bg-green" role="progressbar"
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    <li role="presentation" class="active">
                                        <a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab"
                                           aria-expanded="true">Završni radovi studenata</a>
                                    </li>
                                    <li role="presentation" class="">
                                        <a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab"
                                           aria-expanded="false">Moji Predmeti</a>
                                    </li>
                                    <li role="presentation" class="">
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                                        ...
                                        <ul class="messages">
                                            <li>
                                                <img src="<c:url value='/resources/img/student-1.png' />" class="avatar" alt="Avatar">
                                                ...
                                                <div class="message_wrapper">
                                                    ...
                                                    <p class="url">
                                                        ...
                                                        <a href="#"><i class="fa fa-paperclip"></i> zavrsnirad.doc</a>
                                                    </p>
                                                </div>
                                            </li>
                                            <li>
                                                <img src="<c:url value='/resources/img/student-2.jpg' />" class="avatar" alt="Avatar">
                                                <div class="message_date">
                                                ...
                                                <div class="message_wrapper">
                                                    ...
                                                    <p class="url">
                                                        ...
                                                        <a href="#" data-original-title=""> zavrsnirad.doc</a>
                                                    </p>
                                                </div>
                                            </li>
                                            <li>
                                                <img src="<c:url value='/resources/img/student-3.jpg' />" class="avatar" alt="Avatar">
                                                <div class="message_date">
                                                    <h3 class="date text-info">24</h3>
                                                    <p class="month">May</p>
                                                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade" id="tab_content2"
                                        ...
                                        <table class="data table table-striped no-margin">
                                            ...
                                            <tr>
                                                ...
                                                <th class="hidden-phone">Potrošeni sati</th>
                                                <th>Učešće u odnosu na ostale predmete</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
